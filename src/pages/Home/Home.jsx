...
import herro_title from '../../assets/hero_title.png'
...
const Home = () => {
  return (
    <div className='home'>
      <Navbar/>
      <div className='hero'>
        <img src={herro_banner} alt='herro_banner' className='banner-img' />
        <div className='hero-caption'>
          <img src={herro_title} alt='herro_title' className='caption-img' />
